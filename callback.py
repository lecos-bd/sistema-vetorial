...
# definição dos datas frames de cada dimensão
...
def callbacks(app):
    ...
    def atualizar_gif(estado_selecionado):
        ...
        if os.path.isfile(gif_path):
            return f"/assets/{gif_filename}"  # Caminho relativo para o Dash carregar corretamente
        else:
    ...
    def atualizar_grafico(estado_selecionado, ano_selecionado):
        ...
        df_ambiental_filtrado = df_ambiental[(df_ambiental['Estado'] == estado_selecionado) & (df_ambiental['Ano'] == ano_selecionado)]
        df_seguranca_filtrado = df_seguranca[(df_seguranca['Estado'] == estado_selecionado) & (df_seguranca['Ano'] == ano_selecionado)]
        df_equidade_filtrado = df_equidade[(df_equidade['Estado'] == estado_selecionado) & (df_equidade['Ano'] == ano_selecionado)]
